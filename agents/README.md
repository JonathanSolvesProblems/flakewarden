...
| **Healing Agent** | Draft a selector/synchronization repair for a confirmed flaky test | The test's object repository / selectors + the proposed fix | a *draft* PR-style patch sent to Action Center |
...
- [`healing_agent.json`](healing_agent.json) — Healing Agent definition.
...
measures 95.3% accuracy / 0% safety-FP (see [`../eval/report.md`](../eval/report.md)).
